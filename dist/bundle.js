...
/***/ "./node_modules/css-loader/index.js!./node_modules/sass-loader/lib/loader.js!./src/styles/icons/style.css":
...
// module
exports.push([module.i, "@font-face {\n  font-family: 'icomoon';\n  src: url(" + escape(__webpack_require__("./src/styles/icons/fonts/icomoon.eot?q2vnez")) + ");\n  src: url(" + escape(__webpack_require__("./src/styles/icons/fonts/icomoon.eot?q2vnez")) + "#iefix) format(\"embedded-opentype\"), url(" + escape(__webpack_require__("./src/styles/icons/fonts/icomoon.ttf?q2vnez")) + ") format(\"truetype\"), url(" + escape(__webpack_require__("./src/styles/icons/fonts/icomoon.woff?q2vnez")) + ") format(\"woff\"), url(" + escape(__webpack_require__("./src/styles/icons/fonts/icomoon.svg?q2vnez")) + "#icomoon) format(\"svg\");\n  font-weight: normal;\n  font-style: normal; }\n\n[class^=\"icon-\"], [class*=\" icon-\"] {\n  /* use !important to prevent issues with browser extensions that change fonts */\n  font-family: 'icomoon' !important;\n  speak: none;\n  font-style: normal;\n  font-weight: normal;\n  font-variant: normal;\n  text-transform: none;\n  line-height: 1;\n  /* Better Font Rendering =========== */\n  -webkit-font-smoothing: antialiased;\n  -moz-osx-font-smoothing: grayscale; }\n\n.icon-search3:before {\n  content: \"\\E904\"; }\n\n.icon-search1:before {\n  content: \"\\E902\"; }\n\n.icon-plus:before {\n  content: \"\\E900\"; }\n\n.icon-search2:before {\n  content: \"\\E903\"; }\n\n.icon-plus:before {\n  content: \"\\E900\"; }\n\n.icon-trash:before {\n  content: \"\\E901\"; }\n", ""]);
...
var _elements = __webpack_require__("./src/js/elements.js");

var _state = __webpack_require__("./src/js/state.js");

__webpack_require__("./src/js/director.min.js");

__webpack_require__("./src/styles/index.scss");

__webpack_require__("./src/styles/icons/style.css");
...
function processSearchResults(state, term, elements, callback) {
	return function (data) {
		...
		if (data.tuc[0] && data.tuc[0].phrase) {
			...
			(0, _jquery2.default)("form").find(elements.appInput).val("");
...
function getApiData(state, elements, BASE_URL, searchString, callback) {
	...
	toggleSpinner(elements);
	_jquery2.default.getJSON(BASE_URL, query, callback(state, searchString, elements));
}

function toggleConvertButtonDisabled(state, elements) {
	var isWordListLengthZero = state.wordList.length === 0;
...
function renderSearchResults(state, termData, elements, resultType, msg) {
	var resultTemplate = resultType !== "ERROR" ? "<div class='js-term term inline'></div>" + "<div class='js-translation translation inline'></div>" + "<button class='js-button-add-term button-add-term'>" + "Add" + "</button>" : "<div class='js-error-wrapper error-wrapper'>" + "<div class='js-error error'>" + msg + "</div>" + "</div>" + "<button class='js-button-add-term button-add-term' disabled>" + "Add" + "</button>";

	var wrapperTemplate = (0, _jquery2.default)("<div class='js-search-result search-result well'>" + resultTemplate + "</div>");
	...
	if (!state.isInitialRender) {
		(0, _jquery2.default)(elements.buttonAddTerm).focus();
	}
...
function renderItem(state, term, translation, idx, elements) {
	var template = (0, _jquery2.default)("<div class='js-vocab-list-item vocab-list-item'>" + "	<div class='js-term term'></div>" + "	<div class='js-translation translation inline'></div>" + "<span class='js-button-remove-term button-remove-term icon-trash'></span>" + "</div>");
...
function renderList(state, elements) {
	...
	(0, _jquery2.default)(".js-vocab-list-items").html(listHTML);
}
...
function renderTextArea(wordList, elements) {
	...
	elements.textArea.html(textAreaHTML).find("textarea").val(listString).css("height", textAreaHeight);
}
...
function showApp(elements) {
	...
	showPage(getPageMap(elements), "APP", function () {
		...
		(0, _jquery2.default)("body").css("background-color", grey);
	});
}
...
function showLanding(elements) {
	...
	showPage(getPageMap(elements), "LANDING", function () {
		(0, _jquery2.default)("body").css("background-color", white);
	});
}
...
function initSubmitHandler(state, BASE_URL, elements, formElement, inputElement, callback) {
	(0, _jquery2.default)(formElement).submit(function (e) {
		e.preventDefault();
...
function initAddTermHandler(state, elements) {
	(0, _jquery2.default)(elements.searchResult).on("click", "button", function () {
...
function initConvertHandler(state, elements) {
	(0, _jquery2.default)(".js-button-convert").on("click", function () {
...
function initGetStartedHandler(elements) {
	(0, _jquery2.default)(elements.buttonOnboard).on("click", function () {
		window.location.href = "/#/app";
	});
}

function initLogoClickHandler(elements) {
	(0, _jquery2.default)(elements.appLogo).on("click", function () {
...
function main() {
	...
	var routes = {
		'/': function _() {
			showLanding(_elements.elements);
		},
		'/search': function search() {
			showSearch(_elements.elements);
		},
		'/app': function app() {
			showApp(_elements.elements);
		}
	};
	...
	var spinner = new _spin.Spinner(_config.spinnerOptions).spin();
	_elements.elements.spinner.html(spinner.el);

	_elements.elements.appInput.focus();

	// start app with sample data for demonstration if no data exists in sessionStorage
	var lastSearchedWord = _state.savedWordList ? _state.savedWordList[_state.savedWordList.length - 1].term : "welcome";
	console.log(lastSearchedWord);
	getApiData(_state.state, _elements.elements, _config.BASE_URL, lastSearchedWord, processSearchResultsWithCallback(function () {
		setTimeout(function () {
			_state.state.isInitialRender = false;
		}, 0);
	}));

	renderList(_state.state, _elements.elements);
	toggleConvertButtonDisabled(_state.state, _elements.elements);

	initGetStartedHandler(_elements.elements);
	initLogoClickHandler(_elements.elements);
	initAddTermHandler(_state.state, _elements.elements);
	initConvertHandler(_state.state, _elements.elements);
	initSubmitHandler(_state.state, _config.BASE_URL, _elements.elements, _elements.elements.appForm, _elements.elements.appInput);
	initSubmitHandler(_state.state, _config.BASE_URL, _elements.elements, _elements.elements.searchForm, _elements.elements.searchInput);
}

(0, _jquery2.default)(main());
...
var BASE_URL = exports.BASE_URL = "https://glosbe.com/gapi/translate?callback=?";

var spinnerOptions = exports.spinnerOptions = {
...
var elements = exports.elements = {
  appForm: (0, _jquery2.default)(".js-app-form"),
  appInput: (0, _jquery2.default)(".js-search-bar-input"),
  appLogo: (0, _jquery2.default)(".js-app-logo"),
  appWrapper: (0, _jquery2.default)(".js-app"),
  buttonAddTerm: ".js-button-add-term",
  buttonConvert: (0, _jquery2.default)(".js-button-convert"),
  buttonOnboard: (0, _jquery2.default)(".js-button-onboard"),
  error: (0, _jquery2.default)(".js-error"),
  errorWrapper: (0, _jquery2.default)(".js-error-wrapper"),
  instructions: (0, _jquery2.default)(".js-instructions"),
  landingWrapper: (0, _jquery2.default)(".js-landing"),
  nativeDef: ".js-nativeDef",
  searchForm: (0, _jquery2.default)(".js-search-form"),
  searchIcon: (0, _jquery2.default)(".js-search-bar-icon"),
  searchInput: (0, _jquery2.default)(".js-search-page-input"),
  searchPageSearch: (0, _jquery2.default)(".js-search-page-input"),
  searchResult: (0, _jquery2.default)(".js-search-result-container"),
  searchWrapper: (0, _jquery2.default)(".js-search"),
  spinner: (0, _jquery2.default)(".js-search-bar-spinner"),
  targetDef: ".js-targetDef",
  term: ".js-term",
  textArea: (0, _jquery2.default)(".js-textArea"),
...
var savedWordList = exports.savedWordList = sessionStorage.getItem("wordList") ? JSON.parse(sessionStorage.getItem("wordList")) : null;
...
var state = exports.state = {
	...
	errorMessages: {
		...
		termNotFound: function termNotFound(term) {
			return "Sorry, we don't have a traslation for: <span class='not-found'>" + term + ". </span>" + "<br/> Please check for spelling errors or try another term.";
		}
	}
};
...
/***/ "./src/styles/icons/fonts/icomoon.eot?q2vnez":
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "e06795ebcaca9b1ef0240d694adc5d8c.eot";

/***/ }),

/***/ "./src/styles/icons/fonts/icomoon.svg?q2vnez":
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "2e707bd5395e7e81bef436eef4d2bcde.svg";

/***/ }),

/***/ "./src/styles/icons/fonts/icomoon.ttf?q2vnez":
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "1131f2af5e91fca7ed3d0248eb81ff90.ttf";

/***/ }),

/***/ "./src/styles/icons/fonts/icomoon.woff?q2vnez":
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__.p + "bd28c9569dd2e59c8cd4222fa9cde3f2.woff";

/***/ }),

/***/ "./src/styles/icons/style.css":
/***/ (function(module, exports, __webpack_require__) {

// style-loader: Adds some css to the DOM by adding a <style> tag

// load the styles
var content = __webpack_require__("./node_modules/css-loader/index.js!./node_modules/sass-loader/lib/loader.js!./src/styles/icons/style.css");
...
// load the styles
var content = __webpack_require__("./node_modules/css-loader/index.js!./node_modules/sass-loader/lib/loader.js!./src/styles/index.scss");
if(typeof content === 'string') content = [[module.i, content, '']];
// Prepare cssTransformation
var transform;
